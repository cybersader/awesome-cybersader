...
var require_Async = __commonJS({
  "node_modules/obsidian-dev-utils/dist/lib/Async.cjs"(exports2, module2) {
    ...
    function invokeAsyncSafely3(asyncFn) {
...
var require_implementations = __commonJS({
  "node_modules/obsidian-typings/dist/implementations.cjs"(exports2, module2) {
    ...
    function getTFolderConstructor() {
      return import_obsidian2.TFolder;
    }
  ...
  "node_modules/obsidian-dev-utils/dist/lib/obsidian/FileSystem.cjs"(exports2, module2) {
    ...
    function checkExtension(app, pathOrFile, extension2) {
      ...
      if (typeof pathOrFile === "string") {
        const file = getFileOrNull2(app, pathOrFile);
        if (file) {
          return file.extension === extension2;
        }
        return (0, import_Path.extname)(pathOrFile).slice(1) === extension2;
      }
      return false;
    }
    ...
    function getFile(app, pathOrFile, shouldIncludeNonExisting, isCaseInsensitive) {
      let file = getFileOrNull2(app, pathOrFile, isCaseInsensitive);
      if (!file) {
    ...
    function getFileOrNull2(app, pathOrFile, isCaseInsensitive) {
      const file = getAbstractFileOrNull(app, pathOrFile, isCaseInsensitive);
      if (isFile(file)) {
        return file;
      }
    ...
    function getPath2(app, pathOrFile) {
      if (isAbstractFile(pathOrFile)) {
    ...
    function isCanvasFile3(app, pathOrFile) {
    ...
    function isNote(app, pathOrFile) {
      return isMarkdownFile(app, pathOrFile) || isCanvasFile3(app, pathOrFile);
    }
    ...
    function getResolvedPath(path) {
      return (0, import_obsidian2.normalizePath)((0, import_Path.resolve)("/", path));
    }
  }
});
...
var require_Frontmatter = __commonJS({
  "node_modules/obsidian-dev-utils/dist/lib/obsidian/Frontmatter.cjs"(exports2, module2) {
    ...
    function parseFrontmatter(content3) {
      const frontmatterInfo = (0, import_obsidian2.getFrontMatterInfo)(content3);
      return (0, import_obsidian2.parseYaml)(frontmatterInfo.frontmatter) ?? {};
    }
    function setFrontmatter(content3, newFrontmatter) {
      ...
      const newFrontmatterStr = (0, import_obsidian2.stringifyYaml)(newFrontmatter);
...
var require_Reference = __commonJS({
  "node_modules/obsidian-dev-utils/dist/lib/obsidian/Reference.cjs"(exports2, module2) {
    ...
    __export2(Reference_exports, {
      ...
      sortReferences: () => sortReferences2
    });
    ...
    function sortReferences2(references) {
...
var require_MetadataCache = __commonJS({
  "node_modules/obsidian-dev-utils/dist/lib/obsidian/MetadataCache.cjs"(exports2, module2) {
    ...
    var import_obsidian2 = require("obsidian");
    var import_implementations2 = require_implementations();
    var import_Async3 = require_Async();
    ...
    async function getBacklinksForFileSafe(app, pathOrFile, retryOptions = {}) {
      ...
      const overriddenOptions = { ...DEFAULT_RETRY_OPTIONS, ...retryOptions };
      let backlinks = null;
      await (0, import_Async3.retryWithTimeout)(async () => {
    ...
    function registerFile(app, file) {
      ...
      while (deletedFile.deleted) {
        ...
        deletedFile = deletedFile.parent ?? (0, import_FileSystem3.getFolder)(app, (0, import_implementations2.parentFolderPath)(deletedFile.path), true);
      }
    ...
    async function saveNote(app, pathOrFile) {
      if (!(0, import_FileSystem3.isMarkdownFile)(app, pathOrFile)) {
        return;
      }
      const path = (0, import_FileSystem3.getPath)(app, pathOrFile);
      for (const leaf of app.workspace.getLeavesOfType("markdown")) {
        if (leaf.view instanceof import_obsidian2.MarkdownView && leaf.view.file?.path === path) {
...
var require_Vault = __commonJS({
  "node_modules/obsidian-dev-utils/dist/lib/obsidian/Vault.cjs"(exports2, module2) {
    ...
    __export2(Vault_exports, {
      ...
      getNoteFilesSorted: () => getNoteFilesSorted2,
    ...
    function getNoteFilesSorted2(app) {
      return app.vault.getAllLoadedFiles().filter((file) => (0, import_FileSystem3.isFile)(file) && (0, import_FileSystem3.isNote)(app, file)).sort((a, b) => a.path.localeCompare(b.path));
    }
    function getSafeRenamePath(app, oldPathOrFile, newPath) {
      const oldPath = (0, import_FileSystem3.getPath)(app, oldPathOrFile);
    ...
    async function isEmptyFolder(app, pathOrFolder) {
      const listedFiles = await listSafe(app, (0, import_FileSystem3.getPath)(app, pathOrFolder));
      return listedFiles.files.length === 0 && listedFiles.folders.length === 0;
    }
    async function listSafe(app, pathOrFolder) {
      const path = (0, import_FileSystem3.getPath)(app, pathOrFolder);
    ...
    async function process2(app, pathOrFile, newContentProvider, retryOptions = {}) {
      ...
      await (0, import_Async3.retryWithTimeout)(async () => {
        if (file.deleted) {
          throw (0, import_Async3.marksAsTerminateRetry)(new Error(`File ${file.path} is deleted`));
        }
  ...
  "node_modules/obsidian-dev-utils/dist/lib/obsidian/FileChange.cjs"(exports2, module2) {
    ...
    async function applyFileChanges(app, pathOrFile, changesProvider, retryOptions = {}) {
      ...
      await (0, import_Vault3.process)(app, pathOrFile, async (content3) => {
        ...
        const frontmatter = (0, import_FileSystem3.isCanvasFile)(app, pathOrFile) ? JSON.parse(content3) : (0, import_Frontmatter.parseFrontmatter)(content3);
          ...
          if (isContentChange(change)) {
            ...
            if (actualContent !== change.oldContent) {
              console.warn("Content mismatch", {
                ...
                path: (0, import_FileSystem3.getPath)(app, pathOrFile),
        ...
        if ((0, import_FileSystem3.isCanvasFile)(app, pathOrFile)) {
...
var require_Link = __commonJS({
  "node_modules/obsidian-dev-utils/dist/lib/obsidian/Link.cjs"(exports2, module2) {
    ...
    var import_remark_wiki_link = require_dist();
    var import_Object2 = require_Object();
    var import_Path = require_Path();
    var import_String = require_String();
    ...
    function extractLinkFile2(app, link2, sourcePathOrFile) {
      ...
      return app.metadataCache.getFirstLinkpathDest(linkPath, (0, import_FileSystem3.getPath)(app, sourcePathOrFile));
    }
    function generateMarkdownLink(options) {
      ...
      const targetFile = (0, import_FileSystem3.getFile)(app, options.targetPathOrFile, options.isNonExistingFileAllowed);
      return (0, import_MetadataCache2.tempRegisterFileAndRun)(app, targetFile, () => {
        const sourcePath = (0, import_FileSystem3.getPath)(app, options.sourcePathOrFile);
        const subpath = options.subpath ?? "";
        let alias = options.alias ?? "";
        const isEmbed = options.isEmbed ?? (options.originalLink ? testEmbed(options.originalLink) : void 0) ?? !(0, import_FileSystem3.isMarkdownFile)(app, targetFile);
        ...
        let linkText = targetFile.path === sourcePath && subpath ? subpath : shouldForceRelativePath ? (0, import_Path.relative)((0, import_Path.dirname)(sourcePath), isWikilink ? (0, import_FileSystem3.trimMarkdownExtension)(app, targetFile) : targetFile.path) + subpath : app.metadataCache.fileToLinktext(targetFile, sourcePath, isWikilink) + subpath;
        ...
        if (!isWikilink) {
          ...
          if (!alias && (!isEmbed || !options.isEmptyEmbedAliasAllowed)) {
            alias = !options.shouldIncludeAttachmentExtensionToEmbedAlias || (0, import_FileSystem3.isMarkdownFile)(app, targetFile) ? targetFile.basename : targetFile.name;
          }
    ...
    function shouldResetAlias(options) {
      ...
      const targetFile = (0, import_FileSystem3.getFile)(app, targetPathOrFile);
      const newSourcePath = (0, import_FileSystem3.getPath)(app, newSourcePathOrFile);
      const oldSourcePath = (0, import_FileSystem3.getPath)(app, oldSourcePathOrFile ?? newSourcePathOrFile);
    ...
    function splitSubpath(link2) {
      const parsed = (0, import_obsidian2.parseLinktext)((0, import_String.normalize)(link2));
      return {
    ...
    function updateLink(options) {
      ...
      const targetFile = (0, import_FileSystem3.getFile)(app, newTargetPathOrFile);
      const oldTargetPath = (0, import_FileSystem3.getPath)(app, oldTargetPathOrFile ?? newTargetPathOrFile);
      const isWikilink = testWikilink(link2.original) && shouldForceMarkdownLinks !== true;
      const { subpath } = splitSubpath(link2.link);
      if ((0, import_FileSystem3.isCanvasFile)(app, newSourcePathOrFile)) {
    ...
    async function updateLinksInFile(options) {
      ...
      if ((0, import_FileSystem3.isCanvasFile)(app, newSourcePathOrFile) && !app.internalPlugins.getEnabledPluginById("canvas")) {
        return;
      }
...
var import_Loop2 = __toESM(require_Loop(), 1);
...
function isCanvasPluginEnabled(app) {
  return !!app.internalPlugins.getEnabledPluginById("canvas");
}
var canvasMetadataCacheMap = /* @__PURE__ */ new Map();
function initCanvasHandlers(plugin) {
  const app = plugin.app;
  plugin.register(around(app.metadataCache, {
    getCache: (next) => (path) => getCache(app, path, next)
  }));
  ...
  plugin.register(around((0, import_Object.getPrototypeOf)(canvasPlugin.instance), {
    onUserDisable: () => () => {
...
async function initCanvasMetadataCache(app, file) {
  if (!(0, import_FileSystem.isCanvasFile)(app, file)) {
    return;
  }
  let partialCanvasData;
  try {
    const canvasJson = await app.vault.read(file);
    partialCanvasData = JSON.parse(canvasJson);
  } catch {
    partialCanvasData = {};
  }
  const canvasData = partialCanvasData.nodes ? partialCanvasData : {
    edges: [],
    nodes: []
  };
  ...
  for (let index2 = 0; index2 < canvasData.nodes.length; index2++) {
    const node2 = canvasData.nodes[index2];
    if (node2?.type !== "file") {
      continue;
    }
    cachedMetadata.frontmatterLinks?.push({
      key: `nodes.${index2.toString()}.file`,
      link: node2.file,
      original: node2.file
    });
    const resolvedFile = app.metadataCache.getFirstLinkpathDest(node2.file, file.path);
    ...
    canvasLinksCache[node2.file] = (canvasLinksCache[node2.file] ?? 0) + 1;
  }
...
function getCache(app, path, next) {
  if ((0, import_FileSystem.isCanvasFile)(app, path)) {
    return canvasMetadataCacheMap.get(path) ?? null;
  }
  return next.call(app.metadataCache, path);
}
async function getFileHash(app, file) {
...
function handleFileCreateOrModify(file, plugin) {
  if (!(0, import_FileSystem.isCanvasFile)(plugin.app, file)) {
    return;
  }
...
function handleFileDelete(file, plugin) {
  if (!(0, import_FileSystem.isCanvasFile)(plugin.app, file)) {
    return;
  }
...
function onBacklinksPluginEnable(plugin) {
  (0, import_Async.invokeAsyncSafely)(() => patchBacklinksPane(plugin));
}
function onCanvasPluginDisable(plugin) {
  removeCanvasMetadataCache(plugin);
  reloadBacklinksView(plugin.app);
}
function onCanvasPluginEnable(plugin) {
  (0, import_Async.invokeAsyncSafely)(async () => {
    await processAllCanvasFiles(plugin);
    reloadBacklinksView(plugin.app);
  });
}
async function patchBacklinksPane(plugin) {
  const app = plugin.app;
  ...
  const backlinkView = backlinksLeaf.view;
  plugin.register(around((0, import_Object.getPrototypeOf)(backlinkView.backlink), {
    recomputeBacklink: (next) => function(backlinkFile) {
      recomputeBacklink(app, backlinkFile, this, next);
    }
  }));
}
function patchBacklinksPlugin(plugin) {
  const app = plugin.app;
  const backlinkPlugin = app.internalPlugins.getPluginById("backlink");
  if (!backlinkPlugin) {
    return;
  }
  plugin.register(around((0, import_Object.getPrototypeOf)(backlinkPlugin.instance), {
    onUserEnable: (next) => function() {
      next.call(this);
...
async function processAllCanvasFiles(plugin) {
  await (0, import_Loop.loop)({
    ...
    items: plugin.app.vault.getFiles().filter((file) => (0, import_FileSystem.isCanvasFile)(plugin.app, file)),
...
function reloadBacklinksView(app) {
  const backlinksLeaf = app.workspace.getLeavesOfType("backlink")[0];
  if (!backlinksLeaf) {
    return;
  }
...
function removeCanvasMetadataCache(plugin) {
  const app = plugin.app;
  const canvasFiles = app.vault.getFiles().filter((file) => (0, import_FileSystem.isCanvasFile)(app, file));
...
var BacklinkCachePlugin = class extends import_PluginBase.PluginBase {
  ...
  async onLayoutReady() {
    this.register(around(this.app.metadataCache, {
      getBacklinksForFile: (next) => Object.assign(this.getBacklinksForFile.bind(this), {
        originalFn: next,
    ...
    this.debouncedProcessPendingActions = (0, import_obsidian.debounce)(this.processPendingActions.bind(this), INTERVAL_IN_MILLISECONDS, true);
    initCanvasHandlers(this);
    await this.processAllNotes();
  }
  getBacklinksForFile(pathOrFile) {
    const notePathLinksMap = this.backlinksMap.get((0, import_FileSystem2.getPath)(this.app, pathOrFile)) ?? /* @__PURE__ */ new Map();
    const dict = new import_implementations.CustomArrayDictImpl();
    for (const [notePath, links] of notePathLinksMap.entries()) {
      for (const link2 of (0, import_Reference.sortReferences)(Array.from(links))) {
        dict.add(notePath, link2);
      }
    }
    window.setImmediate(() => {
      (0, import_Async2.invokeAsyncSafely)(this.processPendingActions.bind(this));
    });
    return dict;
  }
  ...
  handleFileDelete(file) {
    this.setPendingAction(file.path, 1 /* Remove */);
  }
  handleFileRename(file, oldPath) {
    this.setPendingAction(oldPath, 1 /* Remove */);
    this.setPendingAction(file.path, 0 /* Refresh */);
  }
  handleMetadataChanged(file) {
    this.setPendingAction(file.path, 0 /* Refresh */);
  }
  async processAllNotes() {
    await (0, import_Loop2.loop)({
  ...
  async refreshBacklinks(notePath) {
    ...
    const noteFile = (0, import_FileSystem2.getFileOrNull)(this.app, notePath);
    if (!noteFile) {
      return;
    }
    if ((0, import_FileSystem2.isCanvasFile)(this.app, noteFile) && !isCanvasPluginEnabled(this.app)) {
      return;
    }
    ...
    for (const link2 of (0, import_MetadataCache.getAllLinks)(cache)) {
      const linkFile = (0, import_Link.extractLinkFile)(this.app, link2, notePath);
      if (!linkFile) {
        continue;
      }
...
// src/main.ts
var main_default = BacklinkCachePlugin;
