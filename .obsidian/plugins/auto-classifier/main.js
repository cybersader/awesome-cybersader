...
// src/api.ts
var ChatGPT = class {
  static async callAPI(system_role, user_prompt, apiKey, model = "gpt-3.5-turbo", max_tokens = 150, temperature = 0, top_p = 0.95, frequency_penalty = 0, presence_penalty = 0.5, baseURL) {
...
var AutoClassifierSettingTab = class extends import_obsidian.PluginSettingTab {
      ...
      if (commandOption.refType == 1 /* Filter */) {
        ...
        new import_obsidian.Setting(containerEl).setName("Manual tags").setDesc("Manually specify tags to reference.").setClass("setting-item-child").setClass("height10-text-area").addTextArea((text) => {
          ...
          cb.setIcon("reset").setTooltip("Bring All Tags").onClick(async () => {
            var _a2;
            const allTags = (_a2 = await this.plugin.viewManager.getTags()) != null ? _a2 : [];
  ...
  async setRefs(refType, value) {
    ...
    const commandOption = this.plugin.settings.commandOption;
    if (refType == 0 /* All */) {
      const tags = (_a2 = await this.plugin.viewManager.getTags()) != null ? _a2 : [];
...
var ViewManager = class {
  ...
  async insertAtContentTop(value, outType, prefix = "", suffix = "") {
    ...
    if (activeView) {
      const editor = activeView.editor;
      const file = activeView.file;
      const sections = (_a2 = this.app.metadataCache.getFileCache(file)) == null ? void 0 : _a2.sections;
      let topLine = 0;
